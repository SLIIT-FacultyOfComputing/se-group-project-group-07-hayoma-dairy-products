...
// Fix for TypeScript error with html2pdf.js import
declare global {
  interface Window {
    html2pdf: any;
  }
...
export default function SalesAnalyticsDashboard() {
  ...
  const handleExport = () => {
    ...
    if (element) {
      const opt = {
        margin: 0.5,
        filename: `sales-analytics-${timeRange}.pdf`,
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Wrap all PDF export content inside #report */}
      <div id="report" className="space-y-6">
        {isLoading ? (
          ...
          <>
            {/* Insert all dashboard cards & charts */}
