...
const mockInventory: InventoryItem[] = [
  ...
  { id: "2", name: "chemicals", quantity: 25, unit: "kg" },
  { id: "3", name: "sugar", quantity: 100, unit: "cups" },
  { id: "4", name: "coco powder", quantity: 30, unit: "packs" },
  { id: "5", name: "preservatives", quantity: 20, unit: "liters" },
];
